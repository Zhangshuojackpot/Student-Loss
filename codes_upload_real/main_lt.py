...
parser.add_argument('--dataset', type=str, default="CIFAR100", metavar='DATA', help='Dataset name: MNIST, CIFAR10, CIFAR100')
parser.add_argument('--noise_type', type=str, default='asymmetric', help='the noise type: symmetric, asymmetric')
parser.add_argument('--noise_rate', type=float, default=0.4, help='the noise rate')
parser.add_argument('--is_student', type=int, default=1, help='if using the student loss')
parser.add_argument('--loss', type=str, default='JS', help='the loss functions: CE, GCE, SCE, NCEandRCE, JNPL, JS')
